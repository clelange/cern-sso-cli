...
// If username is provided, it's stored as a comment for later validation.
//
//nolint:cyclop // Netscape cookie format serialization with multiple field transformations
